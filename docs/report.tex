...
La mia parte di progetto si concentrava sull'implementazione dettagliata del giocatore, comprendendo la definizione delle sue caratteristiche quali attributi(come la vita, l'esperienza, la relativa classe...) e le sue meccaniche in gioco. Quindi per facilitare la comunicazione tra il model del giocatore (\textit{Player}) e la view, ho introdotto un controller utilizzando il pattern \textit{MVC}.
