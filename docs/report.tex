...
Il problema relativo al meccanismo di fine gioco riguardava l'interfacciamento della schermata con l'utente, a tal proposito mi sono occupato di gestire la conclusione del gioco attraverso due scenari distinti: la vittoria(tramite la \textit{GameVictoryView}) e la sconfitta(tramite \textit{GameOverView}).
