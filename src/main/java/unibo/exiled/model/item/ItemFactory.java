...
public interface ItemFactory {
    ...
    /**
     * Creates a healing item with the specified name, description, and healing value.
     *
    ...
    /**
     * Creates a power-up item with the specified name, description, power-up value, and duration.
     *
     ...
     */
    Item createPowerUpItem(final String name, final String description, final double powerUpValue, final int duration,final AttributeIdentifier boostedAttribute);
